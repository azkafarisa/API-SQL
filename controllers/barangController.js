...
const create = (req, res) => {
    ...
    connection.query(
      ...
      (err, results) => {
        ...
        // If Success
        let sqlSelect = `SELECT b.id, b.nama as nama_barang, b.harga, pem.nama as nama_pemasok FROM barang b JOIN pemasok pem = pem.id ON b.id_pemasok WHERE b.id = ${results.insertId}`;
